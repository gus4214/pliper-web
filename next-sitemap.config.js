...
module.exports = {
	siteUrl: process.env.NEXT_PUBLIC_WEB, // .게시하는 site의 url
	...
	exclude: ['/sitemap/prompt-sitemap.xml'],
	robotsTxtOptions: {
		// 추가 sitemap 설정
		additionalSitemaps: [`${process.env.NEXT_PUBLIC_WEB}/sitemap/prompt-sitemap.xml`],
		// 정책 설정
		policies: [
			{
