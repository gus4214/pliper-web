...
const PencilSquareIcon: React.FC<PencilSquareIconProps> = ({ onClick }) => {
	return (
		<>
			<svg xmlns='http://www.w3.org/2000/svg' width='20' height='20' viewBox='0 0 20 20' fill='none' className='group z-10' onClick={onClick}>
				<path
