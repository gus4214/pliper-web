...
import ListItem from '@/src/components/organisms/mypage/profile/profileSection/plipAndMyPrompt/ListItem';
	...
	return (
		<div className='flex flex-col gap-2.5'>
			{lastThreePromptClips.map((promptClip) => (
				<Link key={promptClip.promptId} href={`/mypage/created-prompt/${promptClip.promptId}`}>
					<ListItem
						icon={
