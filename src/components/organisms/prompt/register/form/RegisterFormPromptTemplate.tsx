import LabelWithTemplateFormElement from '@/src/components/organisms/prompt/register/form/elements/LabelWithTemplateFormElement';
import OptionInputComponent from '@/src/components/organisms/prompt/register/form/elements/OptionInputComponent';
