            ...
            <div className='pl-4 border-l border-neutral-100 justify-start items-center flex'>
                <div className='grow shrink basis-0 justify-start items-center gap-4 flex w-[776px]'>
                    <div className='grow shrink basis-0 flex-col justify-start items-start gap-4 flex'>
                        <div className='items-center gap-2 flex'>
                            ...
                            <span
                                className='text-center text-neutral-400 text-[13px] font-normal'>{updateDateTime}</span>
                        </div>
                        <span className='text-lg font-medium'>{title}</span>
                        <LikeAndViewLabel likeCount={String(likeCount)} viewCount={String(viewCount)}
                                          percents={percents} isLikeAuthUser={interaction?.isLike}/>
                    </div>
                </div>
                <div className='w-8 h-8 relative'>
                    <div className={'hover:opacity-70 opacity-100 transition duration-300 ease-in-out'}
                        ...
                        <motion.div whileHover={{scale: 1.2}} whileTap={{scale: 0.9}} transition={{
